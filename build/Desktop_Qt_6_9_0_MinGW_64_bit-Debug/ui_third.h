...
public:
    ...
    void setupUi(QDialog *Third)
    {
        ...
        messageBox = new QPushButton(page_2);
        messageBox->setObjectName("messageBox");
        messageBox->setGeometry(QRect(370, 70, 32, 32));
        QIcon icon1(QIcon::fromTheme(QIcon::ThemeIcon::MailForward));
        messageBox->setIcon(icon1);
        messageBox->setIconSize(QSize(32, 32));
...
#if QT_CONFIG(tooltip)
        messageBox->setToolTip(QCoreApplication::translate("Third", "\320\257\321\211\320\270\320\272 \321\201\320\276\320\276\320\261\321\211\320\265\320\275\320\270\320\271", nullptr));
#endif // QT_CONFIG(tooltip)
