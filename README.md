...
# Без разрешения не вносить никаких изменений
...
- **Вся работа по задачам должна фиксироваться в системе трекинга задач, чтобы все участники могли видеть текущий статус задач.**
