...
## Общая задумка
Приложение имеет несколько отличий. Пользователь создаёт анкету, где указывает кем работает, хобби и увлечения, а также музыкальные предпочтения. Специальный алгоритм находит похожую анкету и предлагает завязать знакомство. Ещё одно важное уточнение - я единственный мужчина в данном приложении. Возможны изменения концепции. Тем не менее нужны фотографии и система регистрации и модерации того, что творится в приложении. Приложение возможно будет только десктоп, ну и возможно мобильные устройства. Необходимо будет получать обратную связь от пользователей и совершенствовать продукт. Концепция еще не определена, но понятно, что нужен дизайнер. 
