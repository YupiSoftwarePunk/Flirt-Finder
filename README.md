...
- Пока существует проблема в виде дублирования реакций на анкеты пользователей в третьем окне и не показываются эти самые пропущенные анкеты - пока не знаю как это поправить
- Нет возможности листать анкеты вперед назад - пока не знаю как это поправить
