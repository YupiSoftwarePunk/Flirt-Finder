...
-  Можно подключить ИИ к камере приложения и при авторизации автоматически будет открываться камера, с помощью которой ИИ будет сравнивать ваше фото профиля и вашу фотография, сделанную сейчас.
