...
Сдесь напишу стек, который планирую использовать: нужен сервер для хранения информации. Java - для мобильного приложения. C++ - desktop приложение. Сам функционал можно писать на чем угодно. Также нужно уметь общаться с базой данных. Не сливать кодовую базу в chat gpt. 
