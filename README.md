...
## Содержание
- [Общая задумка](#Общаязадумка)
- [Возможные названия](#Возможныеназвания)
- [Функционал к реализации](#Функционалпроекта)
- [Планы](#Планынаначальномэтапе)
- [Описание реализованного функционала](#Реализованныйфункционал)
- [Возможные проблемы](#Возможныепроблемы)
- [Стек технологий](#Стектехнологий)
- [Задачи](#Задачи)
- [Информация для контрибьюторов](#Информациядляконтрибьюторов)
- [Информация для участников проекта](#Дляучастниковпроекта)


## Общая задумка
Приложение имеет несколько отличий. Пользователь создаёт анкету, где указывает кем работает, хобби и увлечения, а также музыкальные предпочтения. Специальный алгоритм находит похожую анкету и предлагает завязать знакомство. Ещё одно важное уточнение - я единственный мужчина в данном приложении. Возможны изменения концепции. Тем не менее нужны фотографии и система регистрации и модерации того, что творится в приложении. Приложение возможно будет только веб или десктоп. Необходимо будет получать обратную связь от пользователей и совершенствовать продукт. Концепция еще не определена, но понятно, что нужен дизайнер.
